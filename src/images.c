...
//*****************************************************************************
//
// A simple 16×16 sun icon (X-shaped rays) for GrLib.
//
//*****************************************************************************
const uint8_t g_pui8Sun16x16[] =
{
    IMAGE_FMT_4BPP_COMP,
    16, 0,            // width = 16
    16, 0,            // height = 16
    ...
    //
    // Palette (1 = yellow)
    //   Count = 1 ⇒ 2 entries (index 0 and 1)
    //
    1,
      0x00, 0x00, 0x00,   // index 0: transparent/black
      0xFF, 0xFF, 0x00,   // index 1: yellow

    //
    // RLE-encoded pixel data, row by row (16 rows total).
    // Each byte: upper nibble = run-length, lower nibble = colour index.
    // A run-length of 0 is omitted.
    //
    // Row  0: •..............•  ⇒ [1×■,14×·,1×■]
    0x11,0xE0,0x11,
    // Row  1: ·■............■·  ⇒ [1×·,1×■,12×·,1×■,1×·]
    0x10,0x11,0xC0,0x11,0x10,
    // Row  2
    0x20,0x11,0xA0,0x11,0x20,
    // Row  3
    0x30,0x11,0x80,0x11,0x30,
    // Row  4
    0x40,0x11,0x60,0x11,0x40,
    // Row  5
    0x50,0x11,0x40,0x11,0x50,
    // Row  6
    0x60,0x11,0x20,0x11,0x60,
    // Row  7
    0x70,0x11,0x11,0x70,
    // Row  8
    0x70,0x11,0x11,0x70,
